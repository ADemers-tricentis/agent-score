    ...
    <Box sx={{ p: 3, maxWidth: 860 }}>
      ...
      <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: 3, mb: 3 }}>
        <Box>
          ...
          <Typography variant="body2" sx={{ color: "text.secondary" }}>
            Identity of the agent within AgentScore. Name is immutable once created.
          </Typography>
        </Box>
        ...
        <Paper sx={{ p: 2.5, border: "1px solid", borderColor: "divider", borderRadius: 2 }}>
          <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2 }}>
            ...
            <Box>
              ...
              <Typography variant="body2" sx={{ mt: 0.25 }}>external</Typography>
            </Box>
            <Box>
              <Typography variant="overline" sx={{ color: "text.disabled", fontSize: "0.62rem", letterSpacing: 1, display: "block" }}>
                PROVISIONED AT
              ...
              <Typography variant="body2" sx={{ mt: 0.25 }}>
                {project.fingerprintMatchedAt
                  ? new Date(project.fingerprintMatchedAt).toLocaleString()
                  : "2026-05-01, 9:27:45 AM"}
              </Typography>
            </Box>
          </Box>
        </Paper>
      ...
      <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: 3, mb: 3 }}>
        <Box>
          ...
          <Typography variant="body2" sx={{ color: "text.secondary" }}>
            Who created this agent and when. Read-only.
          </Typography>
        </Box>
        <Paper sx={{ p: 2.5, border: "1px solid", borderColor: "divider", borderRadius: 2 }}>
          <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2 }}>
      ...
      <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: 3, mb: 3 }}>
        <Box>
          <Typography variant="subtitle2" sx={{ fontWeight: 700, mb: 0.5, color: "error.main" }}>Danger zone</Typography>
          <Typography variant="body2" sx={{ color: "text.secondary" }}>
            Soft-delete pauses trace ingest and can be undone. Removing an agent is permanent and cannot be reversed.
          </Typography>
        </Box>
        <Paper sx={{ border: "1px solid", borderColor: "error.light", borderRadius: 2, overflow: "hidden" }}>
          <Box sx={{ px: 2.5, py: 2, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 2 }}>
            <Box>
              <Typography variant="body2" sx={{ fontWeight: 700 }}>Archive agent</Typography>
              <Typography variant="caption" sx={{ color: "text.secondary", display: "block" }}>
                Pauses trace ingest. Traces and runs are preserved.
              </Typography>
            </Box>
            <Button
              variant="outlined"
          ...
          <Box sx={{ px: 2.5, py: 2, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 2 }}>
            <Box>
              <Typography variant="body2" sx={{ fontWeight: 700 }}>Remove agent</Typography>
              <Typography variant="caption" sx={{ color: "text.secondary", display: "block" }}>
                Permanently deletes this agent and all associated data.
              </Typography>
            </Box>
            <Button
              variant="contained"
