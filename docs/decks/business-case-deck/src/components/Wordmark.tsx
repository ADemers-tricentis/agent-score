...
export const Wordmark: React.FC<{
  ...
  color?: string;
  accent?: string;
}> = ({ fontSize = 40, showMark = true, color = brand.white, accent = brand.orange }) => {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: fontSize * 0.32 }}>
      {showMark && (
        <svg width={fontSize * 1.15} height={fontSize * 1.15} viewBox="0 0 100 100">
          <circle cx="50" cy="50" r="40" fill="none" stroke="rgba(255,255,255,0.28)" strokeWidth="10" opacity={0.28} />
          <circle
            cx="50"
            cy="50"
            r="40"
