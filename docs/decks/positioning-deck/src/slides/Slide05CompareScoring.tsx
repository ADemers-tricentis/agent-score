...
import { SCORING_ROWS, LEGEND, FOOTNOTE } from "../data/compareData";
import { surface } from "../theme/theme";

export const Slide05CompareScoring: React.FC = () => (
  <Slide index={5} kicker="Compare & Contrast">
    <Title size={44}>How AgentScore compares - scoring and eval capability</Title>
    <div style={{ fontSize: 16, fontWeight: 700, color: surface.textSecondary, marginTop: 14, marginBottom: 18 }}>
      {LEGEND}
    </div>
    <div style={{ flex: 1, minHeight: 0 }}>
      <CompareTable rows={SCORING_ROWS} />
    </div>
